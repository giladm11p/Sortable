...
function _ghostIsFirst(evt, vertical, sortable) {
  ...
  if (isRtl) {
    return vertical ? evt.clientX > rect.right + spacer || evt.clientY < rect.top && evt.clientX > rect.left : evt.clientY < rect.top - spacer || evt.clientY < rect.bottom && evt.clientX > rect.right;
  }
...
function _ghostIsLast(evt, vertical, sortable) {
  ...
  if (isRtl) {
    return vertical ? evt.clientX < rect.left - spacer || evt.clientX > rect.left && evt.clientY > rect.bottom && evt.clientX < rect.right : evt.clientX < rect.left && evt.clientY > rect.top || evt.clientX > rect.left && evt.clientY > rect.bottom + spacer;
  }
